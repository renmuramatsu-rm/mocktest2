        ...
        <tbody class="list_table-body">
            ...
            <tr class="list_item">
                ...
                <td class="list_item-content">
                    ...
                    <a href="
                    {{ route('detail',$month_day_list['attendance']->id) }}">詳細</a>
                    @else<p>詳細</p>
                    @endif
                </td>
